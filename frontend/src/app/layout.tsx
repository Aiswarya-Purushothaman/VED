...
export const metadata: Metadata = {
  ...
  title: {
    default: "Best Event Decoration in Bangalore | Virtual Events and Decorations",
    template: "%s | Virtual Events and Decorations Bangalore",
  },
  description:
    "Best event decoration services in Bangalore (Bengaluru) for birthdays, weddings, anniversaries, baby showers, corporate events, proposals & candlelight dinners. 500+ happy customers. Call 8884447579.",
  keywords: [
    "best decoration in Bangalore",
    "best decoration in Bengaluru",
    "event decoration Bangalore",
    "event decoration Bengaluru",
    "balloon decoration Bangalore",
    "birthday decoration Bangalore",
    "birthday decor Bengaluru",
    "wedding decoration Bangalore",
    ...
    "room decoration Bangalore",
    "surprise decoration Bangalore",
  ...
  openGraph: {
    title: "Best Event Decoration in Bangalore | Virtual Events and Decorations",
    description: "Best decoration services in Bangalore for birthdays, weddings, anniversaries, proposals & more. 500+ happy customers. Call 8884447579.",
    type: "website",
    url: SITE_URL,
